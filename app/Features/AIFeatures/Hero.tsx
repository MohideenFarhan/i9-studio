...
const AIFeatures = () => {
    ...
    return (
        <>
            ...
            >
                <div className="w-full mt-30 sm:mt-30 md:mt-80 mx-2 md:mx-10 max-w-7xl text-left">
                    <h1 className="text-3xl sm:text-5xl lg:text-8xl md:text-7xl font-extrabold leading-tight">
